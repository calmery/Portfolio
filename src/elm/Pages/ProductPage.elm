...
productPages =
    ...
    , createProductPage secondaryMenu 1 <| Product "PORCH" "2018" "WebSocket を使用したチャットを行うことができる" "calmery/Porch" "https://github.com/calmery/Porch" (Just "porch.png") (Just "porch-sp.png")
