...
experiencePages =
    [ createExperiencesPage secondaryMenu 0 <|
        Experiences
            [ Experience "株式会社サイバーエージェント" "From Sep. 27, 2018 through Oct. 26, 2018" "就業型インターンシップ Engineer JOB" "株式会社サイバーエージェント，REQU で 1 ヶ月間の就業型インターンシップに参加した．" "https://www.cyberagent.co.jp/careers/students/event/detail/id=21660"
            , Experience "チームラボ株式会社" "From Sep. 3, 2018 through Sep. 14, 2018" "チームラボ インターンシップ" "チームラボ株式会社で行われた 2 週間の就業型インターンシップに参加した．" "https://internship.team-lab.com/"
            , Experience "株式会社メルカリ" "From Aug. 1, 2018 through Aug. 31, 2018" "Summer Internship 2018" "株式会社メルカリで行われた 1 ヶ月間の就業型インターンシップに参加した．" "https://mercan.mercari.com/entry/2018/06/01/163000"
    ...
    , createExperiencesPage secondaryMenu 3 <|
        Experiences
